...
ModulePass* createSimpleCallGraphPass();
ModulePass* createClassObjectAccessPass();
ModulePass* createExternCallFinderPass();
ModulePass* createIfStatementsPass();
ModulePass* createBackwardPropigatePass();
ModulePass* createParamCallFinderPass();
ModulePass* createParamUsageFinderPass();
ModulePass* createGatherResultsPass();
ModulePass* createFindConstCompsPass();
